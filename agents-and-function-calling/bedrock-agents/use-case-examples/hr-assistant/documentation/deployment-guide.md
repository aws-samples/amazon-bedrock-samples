...
cfn_nag_scan --input-path agents-and-function-calling-for-bedrock/use-case-examples/hr-assistant/cfn/hr-resources.yml
```
---
...
```sh
pip install -r agents-and-function-calling-for-bedrock/use-case-examples/hr-assistant/streamlit/requirements.txt
```

3. Run the streamlit app locally with 
```sh
python3 -m streamlit run agents-and-function-calling-for-bedrock/use-case-examples/hr-assistant/streamlit/agent_streamlit.py
```
