...
valid_embedding_models = ["cohere.embed-multilingual-v3", "cohere.embed-english-v3", "amazon.titan-embed-text-v1", "amazon.titan-embed-text-v2:0"]
...
class BedrockKnowledgeBase:
    ...
    def create_knowledge_base(self):
        ...
        if self.chunking_strategy == "FIXED_SIZE":
            print("Creating KB with chunking strategy - ", self.chunking_strategy)
            chunking_strategy_configuration = {
            ...
            print("Creating KB with chunking strategy - NONE")
            chunking_strategy_configuration = {
        ...
        try:
            ...
            print(chunking_strategy_configuration)
    ...
    def delete_kb(self, delete_s3_bucket=False, delete_iam_roles_and_policies=True):
        ...
        with warnings.catch_warnings():
            ...
            try:
                ...
                print("======== Knowledge base and data souce deleted =========")
    ...
    def delete_iam_roles_and_policies(self):
        ...
        try:
            ...
            print("======== IAM roles and policies deleted =========")
        except Exception as e:
            print(e)
