...
class E2ERagUsingBedrockKbCdkStack(Stack):

    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        # create IAM role to be used for setting up e2e RAG solution
        Kbrole = KbRoleStack(self, "KbRoleStack").kbrole.role_name
        print("IAM role created: ",Kbrole)
