...
knowledge_base_s3_bucket = os.environ['KB_BUCKET_NAME'] # Need to update
...
# Knowledge Bases for Amazon Bedrock - RetrieveAndGenerate API
def bedrock_query_knowledge_base(query):
    ...
    # Include filter attribute if selected
