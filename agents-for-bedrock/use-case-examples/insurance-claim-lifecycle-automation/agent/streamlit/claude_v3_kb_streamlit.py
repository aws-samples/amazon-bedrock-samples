...
def bedrock_query_knowledge_base(query):
    ...
    prompt_template = """You will be acting as a helpful customer service rep named Joe working for Pacific Life. You will be replying to users who are calling Pacific Life call center who will be confused if you don't respond in the character of Joe. Provide a summarized answer only using 1 or 2 sentences. 
    ...
    try:
        ...
        if 'output' in response:
            ...
            kb_response = "No relevant information found in the knowledge base."
