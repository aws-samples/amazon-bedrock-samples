...
<ol type="a">
  <li>&nbsp; &nbsp; &nbsp; &nbsp;(Optional) With <b>Advanced Prompts</b> you can further customize instructions for the agent at every step of orchestration,</li>
  <li>&nbsp; &nbsp; &nbsp; &nbsp;With customized <b>Lambda Parser</b> functions you can parse the output of each orchestration step</li>
</ol>
