...
```sh 
Description: Use this knowledge base to access insurance claims data, including incident type/severity, number of vehicles, relationship to insured, claim amounts, number of witnesses, status, pending documents
```
...
<p align="center">
  <img src="../design/agent-kb-configuration.png" width="95%" height="95%">
</p>
<p align="center">
