...
def on_delete(event, agent_name, physical_id):
  ...
  delete_agent_alias(agent_name=agent_name, alias_name=f'{agent_name}-alias')
...
def delete_agent_alias(agent_name, alias_name):
    ...
    # Find alias with the given name
    ...
    return agent_client.delete_agent_alias(agentId=agent_id, 
