...
invoke_model_endpoint: str = "https://bedrock.us-east-1.amazonaws.com/model/anthropic.claude-v2/invoke"

# Create the request with Bedrock credentials
request = AWSRequest(method='POST', url=invoke_model_endpoint, data=body, params={}, headers={"Accept": "application/json", "Content-Type": "application/json"})
...
response = requests.request(method='POST', url=invoke_model_endpoint, headers=dict(request.headers), data=body)
