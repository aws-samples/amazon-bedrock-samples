...
def build_invoke_model_tools():
    """Build tools for InvokeModel API with cache checkpoint on last tool."""
    tools = []
...
def test_invoke_model_with_response_stream_tools(client):
    """Test tool definition caching with InvokeModelWithResponseStream API."""
    print("\n" + "=" * 60)
    print("Test 1: InvokeModelWithResponseStream (tool definitions)")
    print("=" * 60)
...
def test_invoke_model_tools(client):
    """Test tool definition caching with InvokeModel API."""
    print("\n" + "=" * 60)
    print("Test 2: InvokeModel (tool definitions)")
    print("=" * 60)
...
Examples:
  python demo_tool_definition_caching.py
    ...
    results["InvokeModelWithResponseStream"] = test_invoke_model_with_response_stream_tools(client)
    results["InvokeModel"] = test_invoke_model_tools(client)
