...
displayName: "Automated Reasoning: Guardrail Deployer"
description: "Versions an Amazon Bedrock Automated Reasoning (AR) policy and attaches it to a Bedrock Guardrail for production use. Creates an immutable numbered policy version, then creates or updates a guardrail with the required automatedReasoningPolicyConfig and cross-region guardrail profile."
keywords: ["guardrail deployer", "automated reasoning", "bedrock", "guardrail", "AR policy"]
author: "Adewale Akinfaderin"
---

<!-- GENERATED from skills/ar-guardrail-deployer/SKILL.md by scripts/sync_powers.py — do not edit by hand. Edit the SKILL.md and re-run the script. -->
