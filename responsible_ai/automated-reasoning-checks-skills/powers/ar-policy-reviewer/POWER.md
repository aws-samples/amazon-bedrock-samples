...
displayName: "Automated Reasoning: Reviewer"
description: "Inspects an extracted Amazon Bedrock Automated Reasoning (AR) policy for quality and fidelity before testing or deployment. Fetches the POLICY_DEFINITION, QUALITY_REPORT, and FIDELITY_REPORT build assets and flags unused/duplicate variables, bare assertions, conflicting rules, disjoint rule sets, and low coverage/accuracy scores, producing a prioritized fix list."
keywords: ["reviewer", "automated reasoning", "bedrock", "guardrail", "AR policy", "fidelity", "test", "deploy"]
