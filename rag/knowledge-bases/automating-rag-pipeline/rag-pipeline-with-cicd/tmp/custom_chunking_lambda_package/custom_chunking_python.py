...
# Helper function to process content by chunking text
...
# Extracts images from a PDF and returns them as a list of dictionaries with metadata
        ...
        for image in page.images:
            images.append({
                ...
                'contentMetadata': {
                    ...
                    'base64Image': encode_image(image.data)
                }
            })
    return images
...
def process_images_with_metadata(bedrock_client, model_id: str, input_text: str, images_with_metadata: List[dict]) -> List[dict]:
    ...
    for image_metadata in images_with_metadata:
        ...
        #     results.append({
        #         "contentMetadata": image_metadata['contentMetadata'],
        #         "contentBody": "",
        #         "contentType": "PDF",
