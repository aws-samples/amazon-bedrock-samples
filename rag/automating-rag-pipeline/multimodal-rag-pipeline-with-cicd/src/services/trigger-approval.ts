...
//         const stageName = "Prod"; // Stage where the manual approval happens
...
//         // Find the pipelineExecutionId from the QA stage (ensure it's the latest one)
//         let qaExecutionId: string | undefined;
//         const qaStageName = "QA"; // Ensure this matches the exact stage name for QA

//         for (const stage of stages) {
//             if (stage.stageName === qaStageName && stage.latestExecution) {
//                 qaExecutionId = stage.latestExecution.pipelineExecutionId;
//                 console.log(`QA Stage Execution ID: ${qaExecutionId}`);
//                 break;
//             }
//         }

//         if (!qaExecutionId) {
//             throw new Error("QA execution ID not found.");
//         }

//         // Now search for the approval token in the "Prod" stage
//         let approvalToken: string | undefined;

//         for (const stage of stages) {
//             if (stage.stageName === stageName) {
//                 console.log(`Processing Prod stage with execution ID: ${stage.latestExecution?.pipelineExecutionId}`);

//                 // Search for the manual approval action
...
//             // Fallback to latest execution in the Prod stage for manual approval
//             for (const stage of stages) {
//                 if (stage.stageName === stageName) {
//                     if (stage.actionStates) {
//                         for (const action of stage.actionStates) {
...
// this code works for code changes
// import { CodePipelineClient, GetPipelineStateCommand, PutApprovalResultCommand } from "@aws-sdk/client-codepipeline";
// import { Handler } from "aws-lambda";
...
//         // Extract necessary environment variables
//         const pipelineName = process.env.PIPELINE_NAME;
//         const stageName = "QA"; // Now the manual approval is in the QA stage
//         const actionName = "ManualApprovalForProduction"; // Name of the manual approval action
//         const evaluationResult = event.success; // Get the evaluation result
...
//         // Now search for the approval token in the QA stage
//         let approvalToken: string | undefined;

//         for (const stage of stages) {
//             if (stage.stageName === stageName) {
//                 console.log(`Processing QA stage with execution ID: ${stage.latestExecution?.pipelineExecutionId}`);
...
//             // Fallback mechanism to find any manual approval token in the QA stage
//             for (const stage of stages) {
//                 if (stage.stageName === stageName) {
//                     if (stage.actionStates) {
//                         console.log("Stage action states: ", stage.actionStates);
...
// this is working for the code changes
...
//         // Now search for the approval token in the PostQAApproval stage
//         let approvalToken: string | undefined;
