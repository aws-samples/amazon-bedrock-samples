...
// // Call this function to update the status
// await updateIngestionStatus(bucketName, objectKey, 'in-progress');
// // After successful ingestion
// await updateIngestionStatus(bucketName, objectKey, 'completed');

// // If an error occurs during ingestion
// await updateIngestionStatus(bucketName, objectKey, 'failed');
...
// Call this function to update the status to "not ingested yet"
